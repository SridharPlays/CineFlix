...
function loadMovie(movie) {
    ...
    div.className = "movie";
    div.setAttribute("data-name", movie.name);
    div.innerHTML = `
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    moviesDiv.addEventListener("click", (event) => {
        ...
        if (movieElement) {
            let movieName = movieElement.getAttribute("data-name");
            window.location.href = `movieInfo.html?movieName=${encodeURIComponent(movieName)}`;
        }
    });    
